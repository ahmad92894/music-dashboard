    ...
    .then(function(data){
        ...
        // tableBody.append(tableRow3);
            ...
            for(var i= 0; i < eventArray.length;i++){
                var nameOfEvent = eventArray[i].event.title
